...
public class PaginationState
{
    ...
    public EventCallbackSubscribable<PaginationState> CurrentPageItemsChanged { get; } = new();
    public EventCallbackSubscribable<PaginationState> TotalItemCountChangedSubscribable { get; } = new();
    ...
    // Can be public because this only needs to be called by Table itself, not any custom pagination UI components.
