...
customElements.define('assistant-message', class extends HTMLElement {
    ...
    constructor() {
        ...
        this._style.textContent = `
            :host { display: block; color: inherit; font-size: inherit; line-height: inherit; }
            p { margin: 0 0 0.75rem 0; }
            p:last-child { margin-bottom: 0; }
            ul, ol { margin: 0 0 0.75rem 1.25rem; padding: 0; }
            li { margin-bottom: 0.25rem; }
            pre { background: rgba(0,0,0,0.3); padding: 0.75rem; border-radius: 8px; overflow-x: auto; margin: 0.5rem 0; }
            code { font-family: monospace; font-size: 0.9em; background: rgba(255,255,255,0.1); padding: 0.1em 0.3em; border-radius: 4px; }
            pre code { background: transparent; padding: 0; }
            h1, h2, h3, h4 { margin: 1rem 0 0.5rem 0; font-weight: 600; }
            hr { border: none; border-top: 1px solid rgba(255,255,255,0.15); margin: 1rem 0; }
            blockquote { border-left: 3px solid #4152d5; margin: 0.5rem 0; padding-left: 0.75rem; opacity: 0.9; }
    ...
    _render() {
        ...
        let newValue = this.getAttribute('markdown') || '';
        newValue = newValue.replace(/<citation.*?<\/citation>/gs, '');
        const elements = marked.parse(newValue.replace(/</g, '&lt;'));
        this._container.innerHTML = purify.sanitize(elements, { KEEP_CONTENT: false });
...
// SIG // nM9aVu2Qqg0NutD3Y9ZKvwECBmhbh6JAXRgTMjAyNTA4
// SIG // MTIxOTAzMzAuNTc1WjAEgAIB9KCB0aSBzjCByzELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // 8pUwIhgPMjAyNTA4MTIxNzA0MjFaGA8yMDI1MDgxMzE3
// SIG // MDQyMVowdDA6BgorBgEEAYRZCgQBMSwwKjAKAgUA7EXy
// SIG // lQIBADAHAgEAAgIuAzAHAgEAAgITMjAKAgUA7EdEFQIB
// SIG // ADA2BgorBgEEAYRZCgQCMSgwJjAMBgorBgEEAYRZCgMC
// SIG // oAowCAIBAAIDB6EgoQowCAIBAAIDAYagMA0GCSqGSIb3
// SIG // DQEBCwUAA4IBAQB2hKg5Tvkjf6Rc28fIXSAHNuXH2uhf
// SIG // wp7wgyUcbP2q5feB1v+5ATJZ4GzIBeQNt+9hwGSZSQ+P
// SIG // 8BYP+X0idOgRGwYcfzkCyLD+jwM+2/kbNvvPdiBjglWL
// SIG // 6I1Xh/DtVwHV0o4iz6C+WhTtVJBLydOq9zlnSdlvo4Zs
// SIG // IoHMsDh5MsqH4pCYzpdl/Z787o0IAzzemEOHKD3cTGeS
// SIG // 5MPL/DBE6dOTY9uJe/GBZ/ERqQiH2YqI6en8sZwGNwy0
// SIG // bu2OY0prOhSngG0AbzBBIWOlm/VecZypLOIQG5oJIhpW
// SIG // cTu3XBQl/4WcjeziB/g4Nc/R/ZNeu9DfXtZXO7hFE5B0
// SIG // 1eY3MYIEDTCCBAkCAQEwgZMwfDELMAkGA1UEBhMCVVMx
// SIG // EzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1Jl
// SIG // ZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3Jh
// SIG // dGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3Rh
// SIG // bXAgUENBIDIwMTACEzMAAAIE2OAOB5cyWJgAAQAAAgQw
// SIG // DQYJYIZIAWUDBAIBBQCgggFKMBoGCSqGSIb3DQEJAzEN
// SIG // BgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgcS2s
// SIG // 2Mu3SRYJ1Ou3AA9cqeXJW7FJ0VzssucrjbhaHCYwgfoG
...
// SIG // BNjgDgeXMliYAAEAAAIEMCIEIIpfE8Da0QszIG5tOMFq
// SIG // Z2W6NPI72DFU84gFhyWuurcxMA0GCSqGSIb3DQEBCwUA
// SIG // BIICANlpTeq5x+2vvisSMq7MVmufuWYL7vA55uRnpxr9
// SIG // yjx0bqTdzecFIJru9sF4GcxiV/SH5TzKatXJzXV6Nd0M
// SIG // 95bwi7x/vXGPso0VqgdiWFTIgRGCe+49OCIjuCAXWkCj
// SIG // jOtC2Xl5Z+9ktM+lreQ8CRl15hs6Vek3TzwBFIaiCQ7K
// SIG // rEXPM9Ie2dIAtEZOKib9C6LVUoEwqlm9p4IoNs7RKggR
// SIG // G4N0scB0d7eXnlpTk997fBFiTCZSYSC7yC6xQ2rlAQav
// SIG // hwcPfGyKxmOFH/MROxoObbVUK8HK7P9vbWGfwfdEG30C
// SIG // M6pMj+mb0bKICQ17Eh1Hb2IHp4E6+iZWtFxOHPqjMZOh
// SIG // 5ZAjy2SPxwOs+/G5GcptteQq5q0wGxAKA85ztO2qrmUn
// SIG // QVP+SMPvilQd/fUg/DADPtpPYuLonkR7tCsZNXCJBNyG
// SIG // kwy8mRwTZfimxvR69hf2xnlhE+qbajm/2MwSeVjyiIzC
// SIG // VCzxA1BGe9AmO9xks5zrag31n7EBtEn0hBn0hAisL9ql
// SIG // aOXWOI9ROXHLuAegh7pxjJ5tLaGwy6Ca3srBbN1jXYQS
// SIG // 0K57AADUnbLUn0z0RuRKB/18orC7nzpoyueDFxf2qS5M
// SIG // APH1R/i8/nec0vrzV5CLUdCCedJ17ujQlIb8mbQnJfvz
// SIG // V89BCloztM3ownvpYMRbTLLqsQy4
