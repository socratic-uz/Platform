...
using static Identifying.Application.Protos.AuthService;
using static Shopping.Application.Protos.WishService;
...
namespace Infrastructure.Core
{
    public static class GrpcExtension
    {
        public static async Task CreateCallCredentials(AuthInterceptorContext context, Metadata metadata, IServiceProvider serviceProvider)
        {
            ...
            {
                Console.WriteLine($"[GrpcExtension] Error creating call credentials: {e.Message}");
            }
        }
        ...
        public static void AddGrpcClient<TClient>(this IServiceCollection services, string? uriString) where TClient : ClientBase
        {
            ...
            services.AddGrpcClient<TClient>(typeof(TClient).Name, o => { o.Address = new(uriString); })
                    ...
                    .AddCallCredentials((c, m, s) => CreateCallCredentials(c, m, s));
        }
        ...
        public static void AddInfrastructureGrpcClients(this IServiceCollection services, IConfiguration configuration)
        {
